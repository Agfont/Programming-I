...
public class GuiJoc implements KeyListener {
        ...
        while (logica.getEstat() != LogicaJoc.EstatJoc.EXIT) {
            ...
            switch (logica.getEstat()) {
                ...
                case JUGANT:
                    ...
                    break;
                case GAMEOVER:
                    mostrarGameOver(bufferStrategy); // Llamada GameOver
                    break;
                case PAUSAT:
                    break;
                case WIN:
                    mostrarWin(bufferStrategy);
                    break;
            }
    ...
    private void actualitzarJoc() {
        ...
        else if (heroina.haTrobatLesClaus()){
    ...
    private void mostrarWin(BufferStrategy strategy) {
        Graphics g = strategy.getDrawGraphics();
        Graphics2D g2 = (Graphics2D)g; 
        ...
        g2.setFont(f);
        g2.setColor(Color.white);
        g2.drawString("HAS POGUT TROBAR LES CLAUS A TEMPS!!!", 80, 90);
        f = new Font("Dialog", Font.PLAIN, 16);
        g2.setFont(f);
            
        f = new Font("Dialog", Font.PLAIN, 16);
        g2.setFont(f);
        g2.drawString("'ESC' Sortir", 80, 180);
    }
